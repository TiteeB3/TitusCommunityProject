...
public class TurfGrasses extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_turf_grasses);
        ...
        actionBar.setTitle("TURF GRASSES");
    ...
    private void showData() {
        ...
        p.setTitle("Axonopus compressus");
        p.setImg(R.drawable.axonopuscompressus);
        p.setImageView3(R.drawable.secondpicture);
        p.setCommon_name("Carpet grass");
        p.setFamily("Gramineae");
        p.setMethod_of_propagation("Division");
        p.setUses_or_type("Lawn (Shade loving grass), Turf Grasses");
        p.setCondition("");
        ...
        p.setTitle("Chrysopogon aciculatus");
        p.setImg(R.drawable.chrysopogonaciculatus);
        p.setImageView3(R.drawable.secondpicture);
        p.setCommon_name("Love grass, tafo grass");
        p.setFamily("Gramineae");
        p.setMethod_of_propagation("Division");
        p.setUses_or_type("Lawn (Sun loving grass), Turf Grasses");
        p.setCondition("");
        ...
        //2. CHECK AGAIN//
        p = new ModelForPlantList();
        p.setTitle("Cynodon dactylon");
        p.setImg(R.drawable.cynodondactylon);
        p.setImageView3(R.drawable.secondpicture);
        p.setCommon_name("Bermuda/ Bahama grass/ Doob grass");
        p.setFamily("Gramineae");
        p.setMethod_of_propagation("Division");
        p.setUses_or_type("Lawn, Turf Grasses, Playing field");
        p.setCondition("");
