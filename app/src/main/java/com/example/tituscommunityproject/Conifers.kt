...
class Conifers : AppCompatActivity() {
    ...
    private fun showData() {
        ...
        p.common_name = "Norfolk Island pine"
        p.family = "Araucariaceae"
        p.method_of_propagation = "Difficult to propagate"
        p.uses_or_type = "Specimen/Sea-side planting"
        p.condition = ""
        ...
        p = ModelForPlantList()
        p.title = "Thuja orientalis"
        p.img = R.drawable.thujaorientalis
        p.imageView3 = R.drawable.secondpicture
        p.common_name = "Oriental arborvitae"
        p.family = "Cupressaceae"
        p.method_of_propagation = "Seed/ Stem cutting"
        p.uses_or_type = "It makes a lovely specimen plant"
        p.condition = ""
        ...
        //2. CHECK AGAIN//
        p = ModelForPlantList()
        p.title = "Thuja occidentalis"
        p.img = R.drawable.thujaoccidentalis
        p.imageView3 = R.drawable.secondpicture
        p.common_name = "Arborvitae"
        p.family = "Cupressaceae"
        p.method_of_propagation = "Seed/ Stem cutting"
        p.uses_or_type = "It makes a lovely specimen plant"
        p.condition = ""
