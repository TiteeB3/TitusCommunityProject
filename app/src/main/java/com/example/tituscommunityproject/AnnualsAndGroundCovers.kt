...
class AnnualsAndGroundCovers : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        actionBar!!.title = "ANNUALS AND GROUND COVERS"
    ...
    private fun showData() {
        ...
        p.title = "Alternanthera spp."
        p.img = R.drawable.alternantherasp
        p.imageView3 = R.drawable.secondpicture
        p.common_name = "Green, Red, Variegated boarder"
        p.family = "Amaranthaceae"
        p.method_of_propagation = "Division"
        p.uses_or_type = "Bedding plant"
        p.condition = ""
        ...
        p = ModelForPlantList()
        p.title = "Lantana delicatissima"
        p.img = R.drawable.lantanadelicatissima
        p.imageView3 = R.drawable.secondpicture
        p.common_name = "Lantana"
        p.family = "Verbenaceae"
        p.method_of_propagation = "Air-layering"
        p.uses_or_type = "Flowering house plants, Bedding plant "
        p.condition = ""
        ...
        //2. CHECK AGAIN//
        p = ModelForPlantList()
        p.title = "Tribulus cistoides"
        p.img = R.drawable.tribuluscistoides
        p.imageView3 = R.drawable.secondpicture
        p.common_name = "Tribulus"
        p.family = "Zygophyllaceae"
        p.method_of_propagation = "Seed/ Semi-hardwood cutting"
        p.uses_or_type = "Bedding plant/ Edging plant "
        p.condition = ""
