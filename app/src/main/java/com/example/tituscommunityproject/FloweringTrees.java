...
public class FloweringTrees extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("FLOWERING TREES");
    ...
    private void showData() {
        ...
        p.setTitle("Acacia auriculiformis");
        p.setImg(R.drawable.acaciaauriculiforis);
        p.setImageView3(R.drawable.secondpicture);
        p.setCommon_name("Ear leaf acacia");
        p.setFamily("Mimosoideae");
        p.setMethod_of_propagation("Seed");
        p.setUses_or_type("Specimen trees, avenue plants");
        p.setCondition("");
        ...
        p.setTitle("Bauhinia purpurea");
        p.setImg(R.drawable.bauhiniapupurea);
        p.setImageView3(R.drawable.secondpicture);
        p.setCommon_name("Purple bauhinia");
        p.setFamily("Fabaceae");
        p.setMethod_of_propagation("Seed");
        p.setUses_or_type("Specimen, Hedge, Shelter belts");
        p.setCondition("");
        ...
        //2. CHECK AGAIN//
        p = new ModelForPlantList();
        p.setTitle("Bauhinia variegata");
        p.setImg(R.drawable.bauhiniavariegata);
        p.setImageView3(R.drawable.secondpicture);
        p.setCommon_name("Orchid tree");
        p.setFamily("Fabaceae");
        p.setMethod_of_propagation("Seed");
        p.setUses_or_type("Specimen, Hedges, Shelter belts");
        p.setCondition("");
