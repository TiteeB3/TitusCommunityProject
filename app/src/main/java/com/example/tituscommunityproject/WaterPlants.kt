...
class WaterPlants : AppCompatActivity() {
    ...
    private fun showData() {
        ...
        p.title = "Nelumbium nelumbo"
        p.img = R.drawable.nelumbiumnelumbo
        p.imageView3 = R.drawable.secondpicture
        p.common_name = "East Indian lily"
        p.family = "Nymphaeaceae"
        p.method_of_propagation = "Division, Seeds"
        p.uses_or_type = "Water plants"
        p.condition = ""
        ...
        p = ModelForPlantList()
        p.title = "Pistia stratiotes"
        p.img = R.drawable.pistiastratiotes
        p.imageView3 = R.drawable.secondpicture
        p.common_name = "Water lettuce"
        p.family = "Araceae"
        ...
        //2. CHECK AGAIN//
        p = ModelForPlantList()
        p.title = "Thalia dealbata"
        p.img = R.drawable.thaliadealbata
        p.imageView3 = R.drawable.secondpicture
        p.common_name = "Water canna"
        p.family = "Maranthaceae"
        p.method_of_propagation = "Division"
        p.uses_or_type = ""
        p.condition = ""
        p.serial_numbers = "003"
