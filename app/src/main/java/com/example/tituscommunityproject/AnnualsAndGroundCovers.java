...
public class AnnualsAndGroundCovers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_annuals_and_ground_covers);
        ...
        actionBar.setTitle("ANNUALS AND GROUND COVERS");
    ...
    private void showData() {
        ...
        p.setTitle("Alternanthera spp.");
        p.setImg(R.drawable.alternantherasp);
        p.setImageView3(R.drawable.secondpicture);
        p.setCommon_name("Green, Red, Variegated boarder");
        p.setFamily("Amaranthaceae");
        p.setMethod_of_propagation("Division");
        p.setUses_or_type("Bedding plant");
        p.setCondition("");
        ...
        p.setTitle("Lantana delicatissima");
        p.setImg(R.drawable.lantanadelicatissima);
        p.setImageView3(R.drawable.secondpicture);
        p.setCommon_name("Lantana");
        p.setFamily("Verbenaceae");
        p.setMethod_of_propagation("Air-layering");
        p.setUses_or_type("Flowering house plants, Bedding plant ");
        p.setCondition("");
        ...
        //2. CHECK AGAIN//
        p = new ModelForPlantList();
        p.setTitle("Tribulus cistoides");
        p.setImg(R.drawable.tribuluscistoides);
        p.setImageView3(R.drawable.secondpicture);
        p.setCommon_name("Tribulus");
        p.setFamily("Zygophyllaceae");
        p.setMethod_of_propagation("Seed/ Semi-hardwood cutting");
        p.setUses_or_type("Bedding plant/ Edging plant ");
        p.setCondition("");
