...
public class WaterPlants extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("WATER PLANTS");
    ...
    private void showData() {
        ...
        p.setTitle("Nelumbium nelumbo");
        p.setImg(R.drawable.nelumbiumnelumbo);
        p.setImageView3(R.drawable.secondpicture);
        p.setCommon_name("East Indian lily");
        p.setFamily("Nymphaeaceae");
        p.setMethod_of_propagation("Division, Seeds");
        p.setUses_or_type("Water plants");
        p.setCondition("");
        ...
        p.setTitle("Pistia stratiotes");
        p.setImg(R.drawable.pistiastratiotes);
        p.setImageView3(R.drawable.secondpicture);
        p.setCommon_name("Water lettuce");
        p.setFamily("Araceae");
        ...
        //2. CHECK AGAIN//
        p = new ModelForPlantList();
        p.setTitle("Thalia dealbata");
        p.setImg(R.drawable.thaliadealbata);
        p.setImageView3(R.drawable.secondpicture);
        p.setCommon_name("Water canna");
        p.setFamily("Maranthaceae");
        p.setMethod_of_propagation("Division");
        p.setUses_or_type("");
        p.setCondition("");
        p.setSerial_numbers("003");
