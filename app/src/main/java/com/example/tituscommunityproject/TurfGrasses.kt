...
class TurfGrasses : AppCompatActivity() {
    ...
    private fun showData() {
        ...
        p.title = "Axonopus compressus"
        p.img = R.drawable.axonopuscompressus
        p.imageView3 = R.drawable.secondpicture
        p.common_name = "Carpet grass"
        p.family = "Gramineae"
        p.method_of_propagation = "Division"
        p.uses_or_type = "Lawn (Shade loving grass), Turf Grasses"
        p.condition = ""
        ...
        p = ModelForPlantList()
        p.title = "Chrysopogon aciculatus"
        p.img = R.drawable.chrysopogonaciculatus
        p.imageView3 = R.drawable.secondpicture
        p.common_name = "Love grass, tafo grass"
        p.family = "Gramineae"
        p.method_of_propagation = "Division"
        p.uses_or_type = "Lawn (Sun loving grass), Turf Grasses"
        p.condition = ""
        ...
        //2. CHECK AGAIN//
        p = ModelForPlantList()
        p.title = "Cynodon dactylon"
        p.img = R.drawable.cynodondactylon
        p.imageView3 = R.drawable.secondpicture
        p.common_name = "Bermuda/ Bahama grass/ Doob grass"
        p.family = "Gramineae"
        p.method_of_propagation = "Division"
        p.uses_or_type = "Lawn, Turf Grasses, Playing field"
        p.condition = ""
