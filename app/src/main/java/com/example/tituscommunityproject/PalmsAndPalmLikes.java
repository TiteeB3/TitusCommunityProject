...
public class PalmsAndPalmLikes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_palms_and_palm_likes);
        ...
        actionBar.setTitle("PALMS AND PALM LIKES");
    ...
    private void showData() {
        ...
        p.setTitle("Areca catechu");
        p.setImg(R.drawable.arecacatechu);
        p.setImageView3(R.drawable.secondpicture);
        p.setCommon_name("Betel nut palm, Areca nut");
        p.setFamily("Palmaceae, Arecaceae");
        p.setMethod_of_propagation("Cuttings");
        p.setUses_or_type("Foliage house plants,  Palms and palm-likes");
        p.setCondition("");
        ...
        p.setTitle("Borassus flabellifer");
        p.setImg(R.drawable.borassusflabellifer);
        p.setImageView3(R.drawable.secondpicture);
        p.setCommon_name("Lontar palm, Palmyra palm");
        p.setFamily("Palmaceae");
        p.setMethod_of_propagation("Seed");
        p.setUses_or_type("Specimen plants, Avenue trees, Palms and palm-likes");
        p.setCondition("");
        ...
        //2. CHECK AGAIN//
        p = new ModelForPlantList();
        p.setTitle("Caryota urens");
        p.setImg(R.drawable.caryotaurens);
        p.setImageView3(R.drawable.secondpicture);
        p.setCommon_name("Wine fish tail palm");
        p.setFamily("Palmaceae");
        p.setMethod_of_propagation("Seed");
        p.setUses_or_type("Foliage house plant, Good specimen plants, Palms and palm-likes");
        p.setCondition("");
