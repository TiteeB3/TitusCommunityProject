...
class PalmsAndPalmLikes : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        actionBar!!.title = "PALMS AND PALM LIKES"
    ...
    private fun showData() {
        ...
        p = ModelForPlantList()
        p.title = "Borassus flabellifer"
        p.img = R.drawable.borassusflabellifer
        p.imageView3 = R.drawable.secondpicture
        p.common_name = "Lontar palm, Palmyra palm"
        p.family = "Palmaceae"
        p.method_of_propagation = "Seed"
        p.uses_or_type = "Specimen plants, Avenue trees, Palms and palm-likes"
        p.condition = ""
        ...
        //2. CHECK AGAIN//
        p = ModelForPlantList()
        p.title = "Caryota urens"
        p.img = R.drawable.caryotaurens
        p.imageView3 = R.drawable.secondpicture
        p.common_name = "Wine fish tail palm"
        p.family = "Palmaceae"
        p.method_of_propagation = "Seed"
        p.uses_or_type = "Foliage house plant, Good specimen plants, Palms and palm-likes"
        p.condition = ""
